...
const ProductCountsWeek = () => {
  ...
  const navigateToProductCountsWeek = () => {
    navigation.navigate('ProductCountsDays');
  };
  ...
  return (
    <View>
      ...
      <View style={styles.ddccd}>
        <View style={styles.dcd}>
          ...
          <TouchableOpacity style={styles.line2} onPress={navigateToProductCountsDays}>
            ...
            <Text style={styles.uhuh}>Days</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.line2} onPress={navigateToProductCountsWeek}>

            <Text style={styles.uhuh  , styles.active}>Week</Text>
          </TouchableOpacity>
      ...
      <View style={styles.pskd}>
        ...
        <Text style={styles.detail}>Week</Text>
      </View>
...
export default ProductCountsWeek;
